<?php
/**
 * The template for Featured Style 3
 *
...
<div class="blog-feautured">
	...
	<div class="featured-style-3">
		<div class="featured-style-width">
				...
				<article <?php post_class(); ?> itemscope="itemscope" itemtype="http://schema.org/Article">
					...
					<?php if ( has_post_thumbnail() ) : ?>
						<figure class="post-image">
							<a href="<?php the_permalink() ?>"><?php the_post_thumbnail( 'broden-featured-style-3', array( 'itemprop' => 'image' ) ); ?></a>
						</figure>
					<?php endif; ?>
		...
		</div><!-- featured-style-width -->
	</div><!-- featured-style-3 -->
