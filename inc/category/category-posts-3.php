<?php
/**
 * The template for Category Posts Style 3
 *
...
?>
	...
	<?php
		$get_cat_posts = get_theme_mod('broden_category_select_4');
		$get_exclude_post = get_theme_mod('broden_category_exclude_post_4');
		$get_post_id = get_theme_mod('broden_category_post_id_4');
		...
		if($get_cat_posts) {
			...
			$args = array(
				'posts_per_page'   => '4',
				'category_name'    => get_theme_mod('broden_category_select_4'),
				'orderby'          => 'date',
				'order'            => 'DESC',
				'post_type'        => 'post',
				'post_status'      => 'publish',
