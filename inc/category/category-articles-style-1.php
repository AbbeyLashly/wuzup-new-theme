<?php
/**
 * The template for Category Articles Style 1
 *
...
<div class="row theme-category-articles-inwrap theme-category-articles-style-1">
	...
	<article <?php post_class(); ?> itemscope="itemscope" itemtype="http://schema.org/Article">
		...
		<?php if ( has_post_thumbnail() ) : ?>
			<figure class="post-type-image">
				<a href="<?php the_permalink() ?>"><?php the_post_thumbnail( 'broden-grid-medium', array( 'itemprop' => 'image' ) ); ?></a>
			</figure>
		<?php endif; ?>
