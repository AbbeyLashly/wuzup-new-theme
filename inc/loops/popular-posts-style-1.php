		...
		<div class="trending-style-1">
			<div class="row">
				...
				<?php if ($query->have_posts()) : $c=0; while ($query->have_posts()) : $query->the_post(); $c++; $l = $query->post_count; ?>
					...
					<?php if (  $c == 1 || $c == 3 || $c == 4 ) { ?>
						<div class="trending-column <?php if ( $c == 1 || $c == 4 ) { ?>small col-md-3 col-sm-12 col-xs-12<?php } else { ?>big col-md-6 col-sm-12 col-xs-12<?php } ?>">
					<?php } ?>
