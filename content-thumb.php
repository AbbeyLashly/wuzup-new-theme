<?php
/**
 * The template for Thumb Post.
 *
 * @package Broden
 */
?>

<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-6 col-sm-12 col-xs-12 grid-style post-hover'); ?> itemscope="itemscope" itemtype="http://schema.org/Article">
