<?php
/**
 * The template for Grid Post.
 *
 * @package Broden
 */
?>

<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-6 col-sm-12 col-xs-12 grid-style'); ?> itemscope="itemscope" itemtype="http://schema.org/Article">
